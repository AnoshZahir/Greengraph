...
from nose.tools import assert_called_with, assert_equal, assert_almost_equal
from mock import patch
import unittest

def test_build_default_params():
    '''
    Test that the function is passing the parameters correctly to requests.get().
    '''
...
def test_green:
    ...
    '''
    my_map = Map(51.50, -0.12) # create an instance of Map.
    ...
    for data in map_data:
        ...
        3d_input_matrix = data.pop('3d_input_matrix')
        expected_return = data.pop('2d_output_matrix')
        
        my_map.__setattr__('pixels', 3d_input_matrix)
...
def test_count_green(mock_green):
    ...
    for data in map_data:
        ...
        assert.equal(actual_return, expected_return
